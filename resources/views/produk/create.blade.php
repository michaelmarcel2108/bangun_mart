        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-3xl font-black text-construction-black leading-tight uppercase tracking-tighter">
                    REGISTRASI <span class="text-construction-yellow">MATERIAL</span>
                </h2>
                <p class="text-slate-500 text-sm font-medium">Input data material baru ke dalam inventaris gudang.</p>
            </div>
        </div>
    </x-slot>
        ...
        <form action="{{ route('produk.store') }}" method="POST" class="space-y-6">
            ...
            <div class="card-base p-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_produk" value="{{ old('nama_produk') }}" required
                                   class="input-field py-3 font-bold text-slate-800" placeholder="Contoh: Semen Gresik 50kg">
                        ...
                        <div>
                            ...
                            <input type="text" name="barcode" value="{{ old('barcode') }}" required
                                   class="input-field py-3 font-mono text-sm" placeholder="888XXXXXXXX">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="harga_jual" value="{{ old('harga_jual') }}" required
                                       class="input-field py-3 pl-12 font-black text-slate-800" placeholder="0">
                            </div>
                        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-black uppercase text-slate-500 mb-1">Stok Awal</label>
                            <input type="number" name="stok" value="{{ old('stok') }}" required
                                   class="input-field py-3 font-black text-slate-800" placeholder="0">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="stok_minimum" value="{{ old('stok_minimum', 5) }}" required
                                   class="input-field py-3 font-black text-red-600" placeholder="5">
                        </div>
                    </div>
                </div>

                <div class="pt-6 border-t border-slate-100 flex gap-4">
                    <button type="submit" class="flex-1 btn-primary py-4 text-sm tracking-widest">
                        SIMPAN KE GUDANG
                    </button>
